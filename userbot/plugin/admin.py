...
NO_PERM = "`I don't have sufficient permissions! This is so sed. Alexa play Fuck Bin Laden`"
NO_SQL = "`Running on Non-SQL mode!`"

CHAT_PP_CHANGED = "`Chat Picture Changed`"
CHAT_PP_ERROR = "`Some issue with updating the pic,`" \
                "`lode ka admin hu me idhar ,`" \
                "`ghanta right he mere paas idhar.`"
INVALID_MEDIA = "`gandi baat`"
